...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
        ...
        .row.mb-3
          .col-lg-12
            .row.justify-content-center.mb-3
              ...
              .col.col-lg-10.align-self-center.py-4(style='border-bottom: 1px solid #70707078')
    ...
    p.mb-4 De acuerdo con la Ley 100 de 1993, el Sistema de Seguridad Social Integral en Colombia se compone de:

    .row.justify-content-center.mb-5.fondo-tarjeta--tema1V2
      .col-lg-8
        h4.text-center.mt-4(style='margin-bottom:80px;') Composición Sistema de Seguridad Social Integral
        figure(style='margin-bottom:80px;')
          img(src='@/assets/curso/tema1/tema1-2/img1.svg', alt='Composición Sistema de Seguridad Social Integral').mx-auto
